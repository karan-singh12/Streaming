...
import { updatePyramidRoostreaminghema } from "../../validators/Admin/pyramid.validator";
import {
...
router.post(
  "/pyramid/updateRoom",
  validate(updatePyramidRoostreaminghema, "body"),
  auth,
  pyramidController.updatePyramidRoom
);
...
router.post(
  "/cam2cam/getAllRooms",
  validate(getAllCam2CamRoomsSchema, "body"),
  auth,
  cam2camController.getAllCam2CamRooms
);
 ...
 */
router.post(
  "/cam2cam/updatePricing",
  validate(updateCam2CamPricingSchema, "body"),
  auth,
  cam2camController.updateCam2CamPricing
);
